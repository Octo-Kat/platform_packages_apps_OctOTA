...
import com.oct.ota.updater.UpdateChecker;
import com.oct.ota.updater.UpdateListener;
import com.oct.ota.settings.Settings;

import com.commonsware.cwac.wakeful.WakefulIntentService;

public class OctOTA extends Activity implements OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oct_ota);
        ...
        if (UpdateChecker.connectivityAvailable(OctOTA.this)) {
           doTheUpdateCheck();
        } else {
           Toast.makeText(OctOTA.this, R.string.toast_no_data_text, Toast.LENGTH_LONG).show();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.oct_ota_base_menu, menu);
        return true;
    }
    ...
    private void doTheUpdateCheck(){
        ...
        otaChecker.execute(OctOTA.this);
    }
    ...
    private void setDeviceInfoContainer() {
        ...
        } else if (!UpdateChecker.connectivityAvailable(OctOTA.this)) {
    ...
    private void setInitialUpdateInterval() {
        ...
        //set interval to 12h if user starts first time OCTOTA and it was not installed by system before
