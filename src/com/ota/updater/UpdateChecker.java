...
public class UpdateChecker extends AsyncTask<Context, Integer, String> {
    ...
    private String strDevice, octCurVer;
    ...
    protected String doInBackground(Context... arg) {
        mContext = arg[0];
        if (mContext != null && mContext.toString().contains("OctOTA")) {
        ...
        try {
            ...
            mHandler.sendMessage(msg);
            if (mNoLog == false) Log.d(TAG, "strDevice="+strDevice+ "   octCurVer="+octCurVer);
            if (strDevice == null || octCurVer == null) return null;
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
             if(eventType == XmlPullParser.START_DOCUMENT) {
                 ...
                 if (tagMatchesDevice && inFileName) {
                    ...
                    if (!tempFileName.equalsIgnoreCase(octCurVer)) newFileName = tempFileName;
    ...
    private void showNotification() {
        Notification.Builder mBuilder = new Notification.Builder(mContext)
            ...
            .setSmallIcon(R.drawable.ic_notification_octota)
            .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_octota));

        Intent intent = new Intent(mContext, OctOTA.class);
